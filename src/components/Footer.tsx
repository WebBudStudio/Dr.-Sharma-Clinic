...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    { path: '/about', label: 'About Dr. Sharma' },
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <div className="footer-logo">Dr. Sharma Clinic</div>
            <p className="footer-tagline">
              Trusted skin care. Expert hands. Visible results.
              <br /><br />
              Expert dermatology care in Delhi since 2014.
            </p>
            <p className="footer-disclaimer">
              This website is for informational purposes only. Please consult Dr. Sharma for medical advice.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="footer-contact-item">
              ...
              <span>123 Medical Plaza, Connaught Place, Delhi - 110001</span>
            </div>
            <div className="footer-contact-item">
              <svg className="footer-contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="footer-social">
              ...
              <a href="https://wa.me/91XXXXXXXXXX" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="WhatsApp">
                <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-bottom">
          <p>© 2024 Dr. Sharma Clinic. All rights reserved.</p>
